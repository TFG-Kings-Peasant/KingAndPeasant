export async function seedCards(prisma) {
  ...
  const cards = [
    ...
    { nameKing: "Sentinel", typeKing: "Guard", descKing: "Look at the top 3 cards of the deck, then put them back in any order", namePeasant: "Exile", typePeasant: "None", descPeasant: "Exile", copies: 1 },
    ...
    { nameKing: "Reassemble", typeKing: "Action", descKing: "Take up to 2 cards from the discard pile, then Hide up to 1 Rebel or Ready up to 1 Guard", namePeasant: "Rally", typePeasant: "Action", descPeasant: "Draw 2 cards, then Hide up to 2 Rebels", copies: 1 },
